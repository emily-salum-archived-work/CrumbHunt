...
public class AStar {
	...
	public static List<Node> PathFinding(World world, Vector2i start, Vector2i end)
	{
		...
		while(openList.size() > 0)
		{
			...
			for(int i = 0; i < 9; i++ )
			{
				...
				if(x + xi + ((y + yi) * World.WIDTH) >= World.tiles.length)
				{
					return null;
				}
				...
				Node newnode = new Node(a, current, gcost,hcost);
